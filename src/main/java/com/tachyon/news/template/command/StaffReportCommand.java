...
public class StaffReportCommand extends BasicCommand {
    ...
    public void execute(Message message) throws Exception {
        ...
        log.info("임원 키워드 공시 처리중 " + key + " " + findAcptNoUrl(acptNo));
        ...
        if (tables != null && tables.size() > 0) {
            ...
            if (docNm.contains("정정")) {
                ...
                for (String _docNo : _docNos) {
                    deleteBeforeStaffHolder(templateMapper,  _docNo,code);
...
//                    deleteBeforeArticle(templateMapper, _docNo,code, acptNo,findArticleType());
    ...
    private void deleteBeforeStaffHolder(TemplateMapper templateMapper, String docNo, String code) {
